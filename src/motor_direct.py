...
#t = mat['t'][:480].flatten()-mat['t'][100]
#Mem = mat['Mem'][:480].flatten()
...
def odes(t, y):
    ...
    # Equations of motion
    theta_m_ddot = (-cs * (theta_m - theta_l) - bv * (theta_m_dot - theta_l_dot) + Mem_interp(t)) / Jm    # MemMAX * np.sin(2 * np.pi / T * t)) / Jm
